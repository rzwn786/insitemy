    ...
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4" >
        ...
        >
          ...
          <a href="/">
            <p className="dark:text-primary mb-12 text-base italic !leading-relaxed text-primary sm:text-lg md:text-xl">
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#ff5a00" stopOpacity="0" />
                <stop offset="1" stopColor="#ff5a00" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
