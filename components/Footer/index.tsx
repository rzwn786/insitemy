          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/InsiteMY/"
                  ...
                  <a
                    href="https://www.instagram.com/insitemy_/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/company/insite-my-innovations-sdn-bhd"
                    aria-label="social-link"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                INSITE MY SYSTEMS SDN BHD (503124-M)
                </h2>
                <ul>
                  <li>
                    <a
                    ...
                    >
                      Unit 17-11, Level 17, Tower A, Vertical Business Suite, Bangsar South, No.8, Jalan Kerinchi, 59200 Kuala Lumpur, Malaysia
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                INSITE MY.COM SDN BHD (504609-A)
                </h2>
                <ul>
                  <li>
                    <a
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                INSITE MY INNOVATIONS SDN BHD (886636-U)
                </h2>
                <ul>
                  <li>
                    <a
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#FF5A00" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#FF5A00" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
