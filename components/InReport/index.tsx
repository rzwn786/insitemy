     ...
     <div className="container">
        ...
        <div className="-mx-4 flex flex-wrap mt-5">
          <div className="w-full px-4" >
            <div
              className="wow fadeInUp mx-auto max-w-[800px] text-center mt-10"
              data-wow-delay=".2s"
             >
             ...
             >
              ...
              <div className='text-left'>
                  ...
                  Taxpayer as the Supplier
                    ...
                    E-invoice Pre-Submission (Digital Certificate)<br></br>
                    E-invoice Submission (Invoice/Debit/Credit/Refund)<br></br>
                    E-invoice Validation – UIN & invoice data validation, 72 hours real-time validation with Supplier or Buyer via LHDN)<br></br>
                    E-invoice Notification<br></br>
                    Sharing of e-invoice (final e-invoice with QR code)<br></br>
                    Rejection and Cancellation (Buyer rejection, Supplier cancellation)<br></br>
                    TIN & UIN Management<br></br>
                    where goods are shipped to a different recipient and/or address <br></br>
                  </p>
